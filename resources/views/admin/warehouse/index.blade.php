                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-6">
                            <div class="btn-group pull-right">
                                <a href="{{ route('admin.warehouse') }}" class="btn btn-flat btn-primary"
                ...
                <div class="box-body">
                    <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
                        ...
                        <tr>
                            ...
                            <th data-width="66px">Số lượng</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($product_details as $product_dt)
                            <tr>
                                ...
                                <td>
                                    <div
                                        style="background-image: url('{{ Helper::get_image_product_url($product_dt->image) }}'); padding-top: 100%; background-size: contain; background-repeat: no-repeat; background-position: center;"></div>
                                </td>
                                <td>{{ $product_dt->sku_code }}</td>
                                <td>{{ $product_dt->name }}</td>
                                <td>{{ $product_dt->OS }}</td>
                                <td>{{$product_dt->color}}</td>
                                <td>{{$product_dt->orderDetailQuantity ?: 0}}</td>

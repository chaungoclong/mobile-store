...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.advertise.index') }}"><i class="fa fa-sliders" aria-hidden="true"></i> Quản Lý
                Quảng Cáo</a></li>
...
@section('content')
    ...
    <form action="{{ route('admin.advertise.save') }}" method="POST" accept-charset="utf-8"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="upload-image text-center">
                            <div title="Image Preview" class="image-preview"
                                 style="background-image: url('{{ Helper::get_image_post_url() }}'); padding-top: 45%; background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 5px; border: 1px solid #f4f4f4;"></div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="title"
                                   placeholder="Tiêu đề quảng cáo" value="{{ old('title') }}" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="at_home_page">
                                        <option value="0" {{ old('at_home_page') ? '' : 'selected' }}>Trang Thường
                                        </option>
                            ...
                            <div class="col-md-7">
                                <!-- Date range -->
                                <div class="form-group">
                                    <label for="reservation">Ngày Bắt Đầu - Ngày Kết Thúc <span
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.advertise.index') }}" class="btn btn-danger btn-flat pull-right"

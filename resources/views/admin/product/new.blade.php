                    ...
                    <div class="col-md-3">
                        ...
                        <div class="upload-image text-center">
                            <div title="Image Preview" class="image-preview"
                                 style="background-image: url('{{ Helper::get_image_product_url() }}'); padding-top: 100%; background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 5px; border: 1px solid #f4f4f4;"></div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="RAM" class="form-control" id="RAM"
                                           placeholder="RAM" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="ROM" class="form-control" id="ROM"
                                           placeholder="ROM" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">

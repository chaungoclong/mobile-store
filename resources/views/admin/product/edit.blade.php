    ...
    <form id="productForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="upload-image text-center">
                            <div title="Image Preview" class="image-preview"
                                 style="background-image: url('{{ Helper::get_image_product_url($product->image) }}'); padding-top: 100%; background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 5px; border: 1px solid #f4f4f4;"></div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="producer_id" required>
                                        ...
                                        @foreach($producers as $producer)
                                            <option
                                                value="{{ $producer->id }}" {{ $product->producer_id == $producer->id ? 'selected' : '' }}>{{ $producer->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="monitor" class="form-control" id="monitor"
                                           placeholder="Màn hình" required autocomplete="off"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="front_camera" class="form-control" id="front_camera"
                                           placeholder="Camera trước" required autocomplete="off"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rear_camera" class="form-control" id="rear_camera"
                                           placeholder="Camera sau" required autocomplete="off"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="OS" required>
                                        ...
                                        <option value="Android" {{ $product->OS == 'Android' ? 'selected' : '' }}>
                                            Android
                                        </option>
                                        <option value="IOS" {{ $product->OS == 'IOS' ? 'selected' : '' }}>IOS</option>
                                        <option
                                            value="Windows Phone" {{ $product->OS == 'Windows Phone' ? 'selected' : '' }}>
                                            Windows Phone
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="CPU" class="form-control" id="CPU" placeholder="CPU"
                                           required autocomplete="off" value="{{ $product->CPU }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="GPU" class="form-control" id="GPU" placeholder="GPU"
                                           required autocomplete="off" value="{{ $product->GPU }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="RAM" class="form-control" id="RAM"
                                           placeholder="RAM" required autocomplete="off" value="{{ $product->RAM }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="ROM">ROM (GB) <span class="text-red">*</span></label>
                                    <input type="number" min="1" name="ROM" class="form-control" id="ROM"
                                           placeholder="ROM" required autocomplete="off" value="{{ $product->ROM }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pin" class="form-control" id="pin" placeholder="Pin"
                                           required autocomplete="off" value="{{ $product->pin }}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="box box-primary">
                            ...
                            <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
                                ...
                                <div class="box-body" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="color_{{ $product_detail->id }}">Mầu Sắc <span
            ...
            <div class="text-center box-footer">
                <button class="add btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Thêm Mầu Sắc Sản Phẩm
                </button>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_details[{?}][color]" class="form-control color"
                                       id="color_{?}" placeholder="Mầu sắc" required autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="quantity_{?}">Số Lượng <span class="text-red">*</span></label>
                                <input type="number" min="1" name="product_details[{?}][quantity]" class="form-control"
                                       id="quantity_{?}" placeholder="Số lượng" required autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="import_price_{?}">Giá Nhập (VNĐ) <span class="text-red">*</span></label>
                                <input type="text" name="product_details[{?}][import_price]"
                                       class="form-control currency" id="import_price_{?}" placeholder="Giá nhập"
                                       required autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_details[{?}][sale_price]" class="form-control currency"
                                       id="sale_price_{?}" placeholder="Giá bán" required autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="promotion_price_{?}">Giá Khuyến Mại (VNĐ)</label>
                                <input type="text" name="product_details[{?}][promotion_price]"
                                       class="form-control currency" id="promotion_price_{?}"
                                       placeholder="Giá khuyến mại" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right reservation"
                                           name="product_details[{?}][promotion_date]" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box box-solid box-default" style="margin-bottom: 5px;">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                            <i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool delete-promotion" title="Remove"><i class="fa fa-times"></i>
                        </button>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="text" name="product_promotions[{?}][content]"
                                       class="form-control promotion" id="promotion_{?}" placeholder="Khuyến Mãi"
                                       required autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right promotion-reservation"
                                           name="product_promotions[{?}][promotion_date]" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                    </div>

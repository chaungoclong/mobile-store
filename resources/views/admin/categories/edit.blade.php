...
@section('content')
    ...
    <form action="{{ route('admin.categories.update', ['category' => $category]) }}" method="POST" accept-charset="utf-8"
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                   placeholder="Tên nhà sản xuất" required value="{{ old('name', $category->name ?? '') }}"
                                   autocomplete="off">
                            @error('name')
                    ...
                    <div class="box-body">
                        <div class="upload-image text-center">
                            <div title="Image Preview" class="image-preview"
                                 style="background-image: url('{{ $category->logo_url_link ?? ''  }}'); padding-top: 50%; background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 5px; border: 1px solid #f4f4f4;">

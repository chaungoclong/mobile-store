...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.producers.index') }}"><i class="fa fa-newspaper-o" aria-hidden="true"></i> Quản Lý
                Nhà sản xuất</a></li>
        <li class="active">Tạo Nhà sản xuất Mới</li>
    </ol>
@endsection
...
@section('content')
    ...
    <form action="{{ route('admin.producers.update', ['producer' => $producer]) }}" method="POST" accept-charset="utf-8"
        ...
        <div class="row">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                   placeholder="Tên nhà sản xuất" required value="{{ old('name', $producer->name ?? '') }}"
                                   autocomplete="off">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control" id="slug"
                                   placeholder="Slug" required value="{{ old('slug', $producer->slug ?? '') }}"
                                   autocomplete="off">
            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    <div class="box-header with-border"><b>Logo</b> <span class="text-red">*</span></div>
                    <div class="box-body">
                        <div class="upload-image text-center">
                            <div title="Image Preview" class="image-preview"
                                 style="background-image: url('{{ $producer->logo_url_link ?? ''  }}'); padding-top: 50%; background-size: contain; background-repeat: no-repeat; background-position: center; margin-bottom: 5px; border: 1px solid #f4f4f4;">

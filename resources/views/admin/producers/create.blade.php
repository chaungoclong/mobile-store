...
@section('content')
    ...
    <form action="{{ route('admin.producers.store') }}" method="POST" accept-charset="utf-8"
        ...
        <div class="row">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                   placeholder="Tên nhà sản xuất" required value="{{ old('name') }}"
                                   autocomplete="off">
                            @error('name')
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border"><b>Thêm Nhà sản xuất</b></div>
                    <div class="box-body">
